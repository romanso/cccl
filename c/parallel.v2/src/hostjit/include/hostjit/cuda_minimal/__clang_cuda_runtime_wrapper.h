...
//     atexit() call binds to this shim locally and is never interposed by libc's
//     atexit (which would defer the dtor to process exit and reintroduce the
...
#      endif
#    else
#      define __HOSTJIT_TABLE_ATTR  __HOSTJIT_EXPORT
#      define __HOSTJIT_ATEXIT_ATTR
#    endif
...
#    endif
  ...
  // Under RDC the whole shared library has ONE fatbin and ONE registration object
