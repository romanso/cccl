...
//     image's own copy. Were it interposable, a second module loaded into the global
//     scope would find the first module's finalizer there, drain its already-empty
//     table and leave its own fatbin registered.
